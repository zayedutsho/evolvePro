  ...
  return (
    ...
    <div className="lg:ml-[140px]">
      ...
      <div className="block lg:hidden text-[14px] lg:text-[18px] font-['Poppins'] mt-[24px] font-normal text-[#999FAE] text-center">
        <h1>
          Discover the Future of Business Interaction with EvolvePro.AI: A Revolutionary Tool Designed to Skyrocket Your Leads, Personalise Customer Engagement, and Streamline Your Operations. Experience the Unparalleled Efficiency of AI-Powered Communication, Tailored to Elevate Your Business in Today's Digital Landscape.</h1>
      </div>
      ...
      <div className="block lg:hidden mt-[24px] lg:mt-[48px] font-medium lg:flex lg:gap-[18px]">
        <div className="flex justify-center items-center"><img src={recImage} alt="recImage" /></div>
    ...
    <div className="hidden lg:block"><img src={gif} alt="gif" /></div>
  </div>
  <div><div className="block absolute lg:hidden top-[65%]"><img src={gif} alt="gif" /></div></div>
  </div>
  );
};
